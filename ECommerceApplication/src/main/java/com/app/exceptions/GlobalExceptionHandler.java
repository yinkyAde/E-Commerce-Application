...
import com.app.domain.response.APIResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> ConstraintsVoilationException(ConstraintViolationException e) {
        Map<String, String> res = new HashMap<>();
    ...
    public ResponseEntity<APIResponse> DataIntegrityException(DataIntegrityViolationException e) {
        APIResponse res = new APIResponse(e.getMessage(), false);
